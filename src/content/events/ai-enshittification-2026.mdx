---
name: AAAI 2026 Spring Symposium on "Bracing for the Enshittification of
  Embodied AI and Robotics"
displayName: AI Enshittification
description: A symposium in the AAAI 2026 Spring Symposium Series that examines
  the phenomoenon of how marketplaces and platform ecosystems can degrade over
  time (coined enshittification), and how that relates to artificial
  intelligence. Researchers from academia, industry, and government will discuss
  potential pitfalls in embodied AI and robotics and a shared vision for
