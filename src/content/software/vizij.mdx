...
useCases:
  ...
  - "Expressive robot face development"
  - "Educational robotics with speech visualization"
  - "Commercial robot character design"
  - "Multi-robot face synchronization"
  - "Emotion expression studies"
  - "Gaze behavior research"
images:
...
contributors:
  ...
  - type: "organization"
    ...
    role: "Development Partner"
    current: true
leadOrganization: "peerbots"
supportingOrganizations: ["semio-ai"]
tags: ["robot-faces", "rendering", "animation", "rigging", "gaze", "visemes", "emotion", "expression", "hri", "open-source"]
featured: true
