		...
		body: (
			<>
				<p className="text-sm text-color-600 dark:text-color-400 mb-3">
					Semio Community is recognized as a tax-exempt organization under section 501(c)(3) of the
	...
	},
	{
		...
		body: (
			<p className="text-sm text-color-600 dark:text-color-400">
				We operate with full transparency and accountability. Financial reports, board meetings, and
				program updates are made available to our community and supporters.
			</p>
		),
	},
];
...
export default function AboutPage() {
	return (
		<div className="space-y-12">
				...
				<div className="max-w-4xl mx-auto">
					<div className="bg-gradient-to-r from-accent-one/10 to-accent-two/10 rounded-lg p-8 border border-accent-one/20 mb-8">
						<p className="text-lg leading-relaxed text-center">
							...
							<span className="font-semibold">501(c)(3) nonprofit organization</span> facilitating
							community-driven robotics hardware, software, and research to foster repeatable,
							reproducible, and replicable science and reusable systems within human-robot
							interaction (HRI).
						</p>
					</div>
					<p className="text-center text-color-600 dark:text-color-400">
						Founded with the belief that the future of robotics lies in collaborative innovation, we
						work to break down barriers between research and application, making cutting-edge
						robotics technology accessible to researchers, educators, and developers worldwide.
					</p>
				</div>
			</Section>
				...
				<div className="max-w-4xl mx-auto">
					<div className="bg-gradient-to-r from-accent-one/10 to-accent-two/10 rounded-lg p-8 border border-accent-one/20 mb-8">
						<p className="text-lg leading-relaxed text-center mb-6">
							Semio Community actively encourages multidisciplinary collaboration among academia,
							industry, and the public sector to drive innovation, ethical practices, and the
							widespread adoption of human-centered robotics technologies.
						</p>
			...
			<Section id="what-we-do" title="What We Do" subtitle="Our key initiatives and programs">
				<div className="max-w-4xl mx-auto">
				...
				<div className="max-w-4xl mx-auto">
					<div className="prose prose-citrus max-w-none text-color-600 dark:text-color-400">
						<p>
							...
							robotics come not from isolated efforts, but from collaborative innovation.
							Recognizing the challenges researchers face in accessing hardware, replicating
							research, and building upon existing work, we set out to create an organization that
							would address these fundamental barriers.
						</p>
						<p>
							As a 501(c)(3) nonprofit, we operate with complete transparency and dedication to our
							mission. Every dollar donated and every hour volunteered directly supports our
							programs to advance open science in robotics.
						</p>
						<p>
							Today, we're proud to support a global community of researchers, educators, and
							developers who share our vision of making robotics technology more accessible,
							reproducible, and impactful for society.
						</p>
					</div>
				</div>
			</Section>
					...
					<div className="bg-surface rounded-lg p-8 border border-special">
						<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
							...
							<div>
								...
								<div className="space-y-4">
									<p className="text-sm text-color-600 dark:text-color-400">
										Follow us on social media and join our mailing list to stay updated on our
										latest initiatives, events, and opportunities.
									</p>
