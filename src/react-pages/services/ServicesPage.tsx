...
const hardwareServices: ServiceDefinition[] = [
	{
		...
		description: "Expert guidance on making your robotic designs ready for scale manufacturing",
	},
	{
		icon: BoxMinimalistic,
		title: "Manufacturing",
		subtitle: "Contract Manufacturing",
		description: "End-to-end scale manufacturing services for robotics hardware",
	},
	{
		icon: Database,
		title: "Inventory",
	...
	},
	{
		...
		description: "Make your hardware available to the broader robotics community",
	},
	{
		icon: Delivery,
		title: "Shipping",
	...
	},
	{
		...
		description: "Ongoing technical support for your robotics hardware platforms",
	},
];
...
const softwareServices: ServiceDefinition[] = [
	...
	},
	{
		...
		description: "Contribute to open projects and earn rewards for solving community challenges",
	},
	{
		icon: ShieldCheck,
		title: "Quality Assurance",
		subtitle: "Testing & Validation",
		description: "Comprehensive testing and validation for robotics applications",
	},
	{
		icon: Document,
		title: "Documentation",
	...
	},
	{
		...
		description: "Ongoing technical support for your robotics software tools and frameworks",
	},
];
...
const researchServices: ServiceDefinition[] = [
	{
		...
		description: "Plan, pre-register, and execute confirmatory studies with standardized protocols",
	},
	{
		icon: Document,
		title: "Grants",
		description: "Identify, develop, and coordinate submissions for research funding",
	},
	{
		icon: UsersGroupTwoRounded,
		title: "Broader Impacts",
		description: "Design and deliver activities and artifacts that meet program requirements",
	},
	{
		icon: SquareAcademicCap,
		title: "Events",
		description: "Plan, host, and support workshops, user studies, and symposia for the community",
	},
	{
		icon: HugeUserGroup,
		title: "Populations",
		description: "Recruit diverse in-person and remote participants, including special populations",
	},
	{
		icon: Chart2,
		title: "Analysis",
		...
		<>
				...
				<div className="max-w-6xl mx-auto">
					...
					<div className="text-center mt-12">
						<p className="text-color-600 dark:text-color-400 mb-6">
							From initial design to global distribution, we provide end-to-end support for your
			...
			>
				<div className="max-w-6xl mx-auto">
					...
					<div className="text-center mt-12">
						<p className="text-color-600 dark:text-color-400 mb-6">
							Transform your research code into robust, production-ready systems with our
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						<div className="flex items-start gap-4">
							...
							<div>
								...
								<p className="text-sm text-color-600 dark:text-color-400">
									Benefit from collective expertise and shared resources across the entire HRI
									community.
								</p>
							</div>
						</div>
						<div className="flex items-start gap-4">
							...
							<div>
								...
								<p className="text-sm text-color-600 dark:text-color-400">
									Speed up your time to market with proven solutions and expert guidance.
								</p>
							</div>
						</div>
						<div className="flex items-start gap-4">
							...
							<div>
								...
								<p className="text-sm text-color-600 dark:text-color-400">
									Ensure reliability and robustness with industry-standard testing and validation.
								</p>
							</div>
						</div>
						<div className="flex items-start gap-4">
							...
							<div>
								...
								<p className="text-sm text-color-600 dark:text-color-400">
									Connect with researchers, developers, and industry partners worldwide.
								</p>
							</div>
						</div>
					</div>
			...
			<Section id="process" title="How It Works" subtitle="Simple steps to access our services">
						...
						{[
							...
							<div key={step} className="flex items-start gap-4">
								<div className="w-10 h-10 rounded-full bg-accent-base/20 flex items-center justify-center shrink-0">
									<span className="text-lg font-bold text-accent-base">{step}</span>
								</div>
								<div>
									<h3 className="font-semibold mb-1">{title}</h3>
									<p className="text-sm text-color-600 dark:text-color-400">{description}</p>
								</div>
							</div>
						))}
					</div>
			...
			<Section id="get-started">
				<div className="max-w-4xl mx-auto text-center">
					...
					<p className="text-lg mb-8 text-color-600 dark:text-color-400">
						Whether you're developing hardware, software, or conducting research, our services can
						help you achieve your goals faster and more effectively.
					</p>
