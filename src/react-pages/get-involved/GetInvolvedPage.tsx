	...
	return (
		<>
			<HeroHeader
				...
				description={
					<>
						Be part of a global community advancing human-centered robotics and AI. Your support
						helps us foster reproducible science and develop reusable systems for human-robot
						interaction.
					</>
				}
				actions={[
				...
				<div className="max-w-5xl mx-auto">
					<div className="bg-linear-to-r from-accent-one/10 to-accent-two/10 rounded-lg p-8 border border-accent-two/20 mb-8 backdrop-blur-lg">
						...
						<p className="text-center mb-6 text-color-600 dark:text-color-400">
							As a 501(c)(3) nonprofit organization, we rely on donations to sustain our mission of
							making robotics research more accessible, reproducible, and impactful.
						</p>
					...
					<div className="bg-surface rounded-lg p-6 border border-special">
						<h3 className="text-lg font-semibold mb-4 text-center">Other Ways to Give</h3>
				...
				<div className="max-w-4xl mx-auto">
					<div className="bg-special-lighter rounded-lg p-8 border border-special backdrop-blur-lg">
							...
							<div>
								...
								<ul className="space-y-2">
									<li className="flex items-start gap-2">
										...
										<span className="text-sm">Regular newsletter with community updates</span>
									</li>
									<li className="flex items-start gap-2">
										<CalendarMark className="w-5 h-5 text-accent-three shrink-0 mt-0.5" />
										<span className="text-sm">Early announcements for events and workshops</span>
									</li>
									<li className="flex items-start gap-2">
										<TestTube className="w-5 h-5 text-accent-three shrink-0 mt-0.5" />
										<span className="text-sm">Research highlights and findings</span>
									</li>
									<li className="flex items-start gap-2">
										<UsersGroupTwoRounded className="w-5 h-5 text-accent-three shrink-0 mt-0.5" />
										<span className="text-sm">Volunteer and collaboration opportunities</span>
									</li>
								</ul>
							</div>
							<div>
						...
						<div className="text-center text-sm text-color-600 dark:text-color-400">
							<p>We respect your privacy and never share your information with third parties.</p>
						</div>
					</div>
				</div>
			</Section>
