...
export default function HomePage({ projectCount, featuredEventCount }: HomePageProps) {
	return (
		<div className="space-y-12">
			...
			>
				<HeroSection projectCount={projectCount} upcomingEventCount={featuredEventCount} />
			</div>
			...
			>
				<p className="text-center text-color-600 dark:text-color-400 mb-4">
					Gather with the community at our events, which explore on a broad range of topics,
					including, but not limited to, human-centered robot hardware, software, and research that,
					with reasonable effort, can be incorporated into the design, development, or deployment of
					an HRI system.
				</p>
				<CallToActionButton href={url("/events")} size="large" variant="default">
					Upcoming Events
				</CallToActionButton>
			</ProgramsSection>
