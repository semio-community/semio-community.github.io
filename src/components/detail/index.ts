...
export type { DetailHeaderProps, DetailHeaderBadge } from './DetailHeader';
...
export type { ContributorsSectionProps, Contributor, Organization } from './ContributorsSection';

export { SpecificationsCard } from './SpecificationsCard';
export type { SpecificationsCardProps, SpecificationItem } from './SpecificationsCard';
