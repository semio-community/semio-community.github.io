...
export interface StatusBadgeProps {
  text: string;
  status?: string;
  color?: 'green' | 'blue' | 'orange' | 'red' | 'yellow' | 'gray' | 'accent-one' | 'accent-two' | 'accent-three' | 'special';
...
export const StatusBadge: React.FC<StatusBadgeProps> = ({
  ...
  // Status to color mapping (based on DetailLayout)
  ...
  const badgeColor = color || (status ? statusColorMap[status] : 'gray') || 'gray';
