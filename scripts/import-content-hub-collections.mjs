...
for (const collectionKey of collectionKeys) {
	...
	for (const fileName of [...fileNames].sort()) {
		...
		const canonicalPath = path.join(sourceRoots[canonicalSite], collectionKey, fileName);
		...
		mergedData.visibility = undefined;
...
console.log(`Imported ${totalImported} entries across collections: ${collectionKeys.join(", ")}.`);
